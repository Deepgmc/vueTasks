      ...
      <form class="form" v-else @submit.prevent="submitHandler">
         ...
         <div class="input-field">
            <input
               ...
               :class="{invalid: ($v.amount.$dirty && !$v.amount.integer) || ($v.amount.$dirty && !$v.amount.required) || ($v.amount.$dirty && !$v.amount.minValue)}"
            >
         ...
         <div class="input-field">
            ...
            >
               Минимум {{$v.description.$params.minLength.min}} символа
            </span>
         </div>
   ...
   methods: {
      async submitHandler(){
         ...
         try {
            ...
            this.$message(`Ошибка создания записи`)
         }
      }
   },
   destroyed(){
